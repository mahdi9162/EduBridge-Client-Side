 ...
 <Container>
  ...
  <motion.section
    ...
    className="
      ...
      rounded-3xl px-4 py-10 md:px-10 md:py-12 lg:px-14
      bg-base-200/35 border border-base-200/60
  ...
  >
    ...
    <div className="relative text-center">
      ...
      <h2 className="mt-3 text-2xl font-extrabold tracking-tight text-base-content md:text-3xl">
        Latest Tutors
      </h2>
      <p className="mt-2 text-sm text-neutral md:text-base">
        Recently active tutors you can trust.
      </p>
    </div>

    {/* grid */}
    <div className="relative mt-10 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4">
          ...
          >
            ...
            <div className="relative flex items-start justify-between gap-3">
              <div className="min-w-0">
                <h3 className="text-[15px] font-bold text-base-content leading-snug truncate">
                  {name}
                </h3>
