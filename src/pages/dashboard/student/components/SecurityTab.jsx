    ...
    <>
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-neutral/80">Password changes are handled securely via email verification.</p>
        </div>
          ...
          <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-3">
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                placeholder="••••••••"
                className="
              input w-full rounded-2xl bg-base-100/70
        ...
        <div className="rounded-2xl border border-base-200 bg-white p-5">
          ...
          <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <Link to="/forgot-password">
              <CommonButton type="button" className="rounded-full px-5 py-2 text-sm font-medium shadow-md w-full sm:w-auto">
                Send reset email
              </CommonButton>
            </Link>
          </div>
